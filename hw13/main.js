...
//2.toFixed(2) - 2 знаки після коми
 ...
 */
console.log('Перетворіть будь-який рядок у верхній регістр'.toUpperCase());
console.log('ПЕРЕТВОРІТЬ РЯДОК У НИЖННІЙ РЕГІСТР'.toLowerCase())